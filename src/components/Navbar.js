        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className={`mx-3 form-check form-switch text-${props.mode === 'light'?'dark':'light'} `}>
              ...
              <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Toggle Grey Dark Mode</label>
            </div>
            <div className={`form-check form-switch text-${props.mode === 'light'?'dark':'light'} `}>
              ...
              <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Toggle Blue Dark Mode</label>
            </div>
          </div>
        </div>
      </nav>
